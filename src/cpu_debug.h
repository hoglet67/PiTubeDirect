...
typedef struct {
  ...
  const char * const *reg_names;                                      // NULL pointer terminated list of register names.
  ...
  const char * const*trap_names;                                            // Null terminated list of other reasons a CPU may trap to the debugger.
