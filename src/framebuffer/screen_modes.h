...
typedef struct screen_mode {
   ...
   void                    (*clear)(const struct screen_mode *screen, const t_clip_window_t *text_window, pixel_t bg_col);
   void                   (*scroll)(struct screen_mode *screen, const t_clip_window_t *text_window, pixel_t bg_col, scroll_dir_t dir);
   ...
   pixel_t            (*get_colour)(const struct screen_mode *screen, uint8_t gcol);
   pixel_t        (*nearest_colour)(const struct screen_mode *screen, uint8_t r, uint8_t g, uint8_t b);
