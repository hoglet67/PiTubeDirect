...
/*static inline size_t read_uleb128_to_uint32(const unsigned char *buf, const unsigned char *buf_end, uint32_t *r)
{
...
static inline size_t read_uleb128_to_uint64(const unsigned char *buf, const unsigned char *buf_end, uint64_t *r)
{
    const unsigned char *p = buf;
    unsigned int shift = 0;
    uint64_t result = 0;
...
static inline size_t read_sleb128_to_int64(const unsigned char *buf, const unsigned char *buf_end, int64_t *r)
{
    const unsigned char *p = buf;
    unsigned int shift = 0;
    int64_t result = 0;
...
static inline size_t skip_leb128(const unsigned char *buf, const unsigned char *buf_end)
{
    const unsigned char *p = buf;
    unsigned char byte;
